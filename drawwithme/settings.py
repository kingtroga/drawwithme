...
SOCIALACCOUNT_PROVIDERS = {
    'google': {
        'APP': {
            'client_id': 'DRAW_WITH_ME_CLIENT_ID',
            'secret': 'DRAW_WITH_ME_CLIENT_SECRET',
        },
        'SCOPE': [
            'profile',
            'email',
...
WSGI_APPLICATION = 'drawwithme.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': os.getenv('DATABASE_PASSWORD', 'default_pass'),
...
MEDIA_URL = '/media/' 
MEDIA_ROOT = os.path.join(BASE_DIR, 'media') #'home/drawwithme/drawwithme/media'
